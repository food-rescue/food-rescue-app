...
public class FoodRescuePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Item balsamicVinegar = new Item("Balsamic Vinegar", "/images/iBalsamicVinegar.jpg");
		Item bananas = new Item("Bananas", "/images/iBanana.jpg");
		Item bread = new Item("Bread", "/images/iBread.jpg");
		Item brownSugar = new Item("Brown Sugar", "/images/iBrownSugar.jpg");
		Item butter = new Item("Butter", "/images/iButter.jpg");
		Item cheese = new Item("Cheese", "/images/iCheese.jpg");
		Item chickenBreast = new Item("Chicken Breast", "/images/iChickenBreast.jpg" );
		Item chiliPowder = new Item("Chili Powder", "/images/iChiliPowder.jpg");
		Item chives = new Item("Chives", "/images/iChives.jpg");
		Item cinnamon = new Item("Cinnamon", "/images/iCinnamon.jpg");
		Item cilantro = new Item("Cilantro", "/images/iCilantro.jpg");
		Item cookedWhiteRice = new Item("Cooked White Rice", "/images/iCookedWhiteRice.jpg");
		Item eggs = new Item("Eggs", "/images/iEggs.jpg");
		Item garlicPowder = new Item("Garlic Powder", "/images/iGarlicPowder.jpg");
		Item garlicSalt = new Item("Garlic Salt", "/images/iGarlicSalt.jpg");
		Item greenOnions = new Item("Green Onions", "/images/iGreenOnions.jpg");
		Item groundBeef = new Item("Ground Beef", "/images/iGroundBeef.jpg");
		Item honey = new Item("Honey", "/images/iHoney.jpg");
		Item lemons = new Item("Lemons", "/images/iLemons.jpg");
		Item lettuce = new Item("Lettuce", "/images/iLettuce.jpg");
		Item limes = new Item("Limes", "/images/iLimes.jpg");
		Item milk = new Item("Milk", "/images/iMilk.jpg");
		Item onions = new Item("Onions", "/images/iOnions.jpg");
		Item pankoBreadCrumbs = new Item("Panko Bread Crumbs", "/images/iPankoBreadCrumbs.jpg");
		Item poblanoPepper = new Item("Poblano Pepper", "/images/iPoblanoPepper.jpg");
		Item potatos = new Item("Potatos", "/images/iPotatos.jpg");
		Item ranchDressing = new Item("Ranch Dressing", "/images/iRanchDressing.jpg");
		Item salmon = new Item("Salmon", "/images/iSalmon.jpg");
		Item sesameSeeds = new Item("Sesame Seeds", "/images/iSesameSeeds.jpg");
		Item soySauce = new Item("Soy Sauce", "/images/iSoySauce.jpg");
		Item steamedBroccoli = new Item("Steamed Broccoli", "/images/iSteamedBroccoli.jpg");
		Item strawberry = new Item("Strawberry", "/images/strawberry.jpg");
		Item tacoShells = new Item("Taco Shells", "/images/iTacoShells.jpg");
		Item tomatoes = new Item("Tomatoes", "/images/iTomatoes.jpg");
		Item tomatoSauce = new Item("Tomato Sauce", "/images/iTomatoSauce.jpg");

...
public class FoodRescuePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Recipe croutons = new Recipe("Croutons", 
				...
				"3.Bake at 350 degrees F (175 degrees C) for 15 minutes or until browned. Let cool. Store croutons in a covered container or plastic bag. Serve in soups or salads.", "/images/croutons.jpg", snack, bread);
		...
		Recipe scrambledEggs = new Recipe("Scrambled Eggs", "1. Beat eggs, milk, salt and pepper in medium bowl until blended. " + 
				...
				"/images/scrambled.jpg", breakfast, eggs, cheese);

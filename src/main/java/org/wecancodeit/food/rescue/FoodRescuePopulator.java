...
public class FoodRescuePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Item cinnamon = new Item("Cinnamon", "/images/iCinnamon.jpg", "Ground cinnamon as well as sticks should be kept in a tightly sealed glass container in a cool, dark, and dry place. Ground cinnamon will keep for about six months, while cinnamon sticks may stay fresh for as long as one year. The best judge of freshness is your nose!");

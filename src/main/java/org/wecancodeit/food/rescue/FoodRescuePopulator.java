...
public class FoodRescuePopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Item avocado = new Item("Avocado", "/images/iAvocado.jpg", "You can brush your avocado's flesh with lemon juice -- the citric acid in the lemon juice dramatically slows the browning process.");
		Item bacon = new Item("Bacon", "/images/bacon.jpg", "Packaged sliced bacon can be kept in its unopened vacuum-sealed package in the refrigerator up to a week past the expiration date. Once opened, keep it tightly wrapped in foil or a zip-top bag and use within one week."); 
		Item balsamicVinegar = new Item("Balsamic Vinegar", "/images/iBalsamicVinegar.jpg", " If you're using balsamic vinegars primarily for salads and like them chilled, they can be refrigerated. If you're using them for sauces, marinades, and reductions, store them in a cupboard.");
		Item bananas = new Item("Bananas", "/images/iBanana.jpg", "To keep a bunch of bananas fresh for longer, wrap the stems in some plastic wrap. Re-cover the bananas with the wrap after removing one.");
		Item bread = new Item("Bread", "/images/iBread.jpg", "The best way to keep bread at its best is to keep it at room temperature for a day or two, then wrap it up and freeze it for longer-term storage. ");
		Item brownSugar = new Item("Brown Sugar", "/images/iBrownSugar.jpg", "You can put a slice of bread or a slice of an apple or even a damp paper towel in with the brown sugar to keep it soft.");
		Item butter = new Item("Butter", "/images/iButter.jpg", "Keep butter refrigerated in its original wrapper. The foil laminated paper helps prevent spoilage from exposure to light and air, and also protects butter from picking up the flavour of other foods.");
		...
		Item chickenBreast = new Item("Chicken Breast", "/images/iChickenBreast.jpg", "To further extend the shelf life of raw chicken, freeze; when freezing, place chicken in the freezer before the number of days shown for refrigerator storage has elapsed.");
		Item chiliPowder = new Item("Chili Powder", "/images/iChiliPowder.jpg", "Red-colored spices (including red pepper, paprika and chili powder) should always be stored in the fridge, especially in hot and humid climates.");
		Item chives = new Item("Chives", "/images/iChives.jpg", "You can place the stems standing up in a glass or jar filled with a few inches of water and covered with a plastic bag. Do not wash until ready to use the chives, as excessive moisture will promote decay.");
		Item cinnamon = new Item("Cinnamon", "/images/iCinnamon.jpg", "Ground cinnamon as well as sticks should be kept in a tightly sealed glass container in a cool, dark, and dry place. The best judge of freshness is your nose!");
		...
		Item cookedWhiteRice = new Item("Cooked White Rice", "/images/iCookedWhiteRice.jpg", "Cooked white rice will generally stay good for 4-6 days in the refrigerator and 6 months in the freezer.");
		...
		Item garlicPowder = new Item("Garlic Powder", "/images/iGarlicPowder.jpg", "Heat damages spices and weakens their flavor. Spices should be kept in a cool, dry, dark area of your kitchen, like in the pantry.");
		Item garlicSalt = new Item("Garlic Salt", "/images/iGarlicSalt.jpg", "Heat damages spices and weakens their flavor. Spices should be kept in a cool, dry, dark area of your kitchen, like in the pantry.");
		...
		Item groundBeef = new Item("Ground Beef", "/images/iGroundBeef.jpg", "Keep refrigerated and use or freeze within 1 to 2 days of purchase. It's okay to keep the ground beef in its original store packaging when refrigerating.");
		...
		Item lemons = new Item("Lemons", "/images/iLemons.jpg", "While there's nothing wrong with keeping your lemons out on the counter, they'll definitely stay fresh longer if you put them in the fridge in a sealed plastic bag.");
		Item lettuce = new Item("Lettuce", "/images/iLettuce.jpg", "Transfer the lettuce to a colander and shake off excess water. Lay out and air dry the lettuce on a clean counter, dish towel, or paper towels until completely dry. Place the lettuce in a gallon plastic zip-top bag along with a paper towel."); 			
		...
		Item milk = new Item("Milk", "/images/iMilk.jpg", "Milk can be frozen for up to 6 weeks without any impact on its flavor and nutritional value; however, upon thawing, it can separate and lose its smooth texture.");
		Item onions = new Item("Onions", "/images/iOnions.jpg",  "Take a brown paper sandwich bag and fold it in half lengthwise. Using a hole punch, punch holes down both sides of the folded bag. ");
		...
		Item potatoes = new Item("Potatoes", "/images/iPotatos.jpg", "Place them in a paper bag, cardboard box, or bowl (not in a plastic bag) and keep them in the coolest part of the kitchen or a dry part of your basement, it should help their longevity.");
		...
		Item strawberry = new Item("Strawberry", "/images/strawberry.jpg", "Arrange the berries (without washing or removing the stems) on a paper towel-lined tray and cover with plastic wrap; then refrigerate. Before eating or using them, wash the berries under cool water and then remove stems.");
		Item tacoShells = new Item("Taco Shells", "/images/iTacoShells.jpg", "Put them in a freezer bag. It's a much thicker plastic and will keep them fresh for a long time even if not in the freezer.");
		...
		tagRepo.save(snack);   
 		...
 		Recipe lettuceWrap = new Recipe("Chicken, Bacon, Avocado Ranch Lettuce Wrap", "1) Start by seasoning the chicken with salt and pepper, then grill them (you could do stovetop as well).\r\n" + 
 				...
 				"8) Eat it like a taco and enjoy!", "/images/chicken.jpg", lunch, avocado, bacon, cilantro, chickenBreast, lettuce, limes, ranchDressing, tomatoes);
 		...
 		Recipe hashbrownWaffle = new Recipe("Egg & Cheese Hashbrown Waffle", "1) Heat waffle iron on medium-high setting. Spray each side generously with non-stick cooking spray or brush with melted butter. " + 
 				...
 				"4) *Tip: Turn your oven to the \"warm\" function and place finished waffles on a baking sheet in the oven to keep warm while the rest are cooking.", "/images/waffles.jpg", breakfast, potatoes, eggs, cheese, butter, milk, chives);
